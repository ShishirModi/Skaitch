...
def download_iiitd(output_dir):
    ...
    # This usually requires manual request from https://iab-rubric.org/index.php/iiit-d-sketch-database
    print(">> IIIT-D Sketch Database typically requires an explicit request via email.")
    print(">> Please visit: https://iab-rubric.org/index.php/iiit-d-sketch-database")
    print(f">> Extract the obtained dataset to: {iiitd_dir}")

def main():
    parser = argparse.ArgumentParser(description="Download Forensic Composite Datasets (CUFS, IIIT-D)")
